...
<body>
    ...
    @csrf
        ...
        <div class="">
            ...
            <input type="text" name="nama_wisata" class="form-control rounded-top  @error('nama_wisata')is-invalid @enderror" id="nama_wisata" placeholder="Nama Wisata" required value="{{ old('nama_wisata') }}"></br></br>
            @error('nama_wisata')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
